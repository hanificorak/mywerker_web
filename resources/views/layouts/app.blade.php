...
<footer class="bg-white border-t border-gray-100 pt-14 pb-8">
    <div class="max-w-7xl mx-auto px-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-500">
                    <li class="flex items-start gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#FF6B00] mt-0.5 flex-shrink-0"
                        ...
                        <span>Levent, Büyükdere Cd. No:123<br />İstanbul,
                            Türkiye</span>
                    </li>
        ...
        <div class="border-t border-gray-100 pt-6 flex items-center justify-between text-sm text-gray-400">
            <span>© 2023 MyWerker. Tüm hakları saklıdır.</span>
