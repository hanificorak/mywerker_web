        ...
        <div class="grid grid-cols-4 gap-12 mb-12">
            <div>
                ...
                <div class="flex items-center gap-3">
                    <a href="https://www.facebook.com/profile.php?id=61587563338762" target="_blank"
                    ...
                    <a href="https://www.instagram.com/nubifysoftware/" target="_blank"
                        class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200">
                        <svg class="w-4 h-4 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://www.linkedin.com/company/nubify-software/" target="_blank"
                        class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200">
                        <svg class="w-4 h-4 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
                            <path
